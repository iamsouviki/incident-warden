...
import com.company.warden.service.IncidentService;
...
public class IncidentController {
    ...
    @Autowired
    private com.company.warden.service.RateLimiterService rateLimiter;

    @Autowired
    private com.company.warden.config.CurrentUser currentUser;

    @Autowired
    private com.company.warden.service.IncidentGraphService graph;
